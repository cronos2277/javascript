...
exports.up = function(knex, Promise) {
  ...
  return knex.schema.createTable('categories', table => {      
    ...
    /*
      O metodo 'references()' junto com o 'inTable()' criam o relacionamento.
      no references voce informa a primary key da outra tabela e no inTable
      voce afirma a tabela aonde esse campo se relaciona. Exemplo:
      <parametro>.<tipo>('nomeDoCampo').references('<IDDaTabela>').inTable('<tabela>');    
    */
