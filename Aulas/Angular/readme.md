...
<p>Aqui por fim temos o servico o objeto que faz efetivamente a conexao: <a href="./advancedapp/src/app/firebase/service.service.spec.ts">service.service.spec.ts</a></p>
