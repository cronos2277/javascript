    ...
    switch(action.type){        
        ...
        */
        ...
        case Commands.GETTER_UPDATE:{
            ...
            //Procuramos por elemento a ser modificado na copia
            const i = cmd.findIndex(st => st._id == action.payload._id); 
            if(i >= 0) cmd[i] = action.payload; //Se o mesmo for encontrado, nos modificamos.
